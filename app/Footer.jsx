            ...
            <div className="w-full max-w-screen-xl mx-auto px-4 md:py-4">
                <div className="sm:flex sm:items-center sm:justify-between">
                    ...
                    <ul className="flex flex-wrap items-center mb-6 text-sm font-medium text-gray-500 sm:mb-0 dark:text-gray-400">
                        ...
                        <li className='m-2'>
                            <a href="https://github.com/adityach0uhan/adityach0uhan" className="mr-4 hover:text-white md:mr-6 ">Aditya Singh Chauhan</a>
                        </li>
                        <li className='m-2'>
                            <a href="https://github.com/dheeraj4200" className="mr-4 hover:underline md:mr-6 hover:text-white">Dheeraj Patel</a>
                        </li>
                        <li className='m-2'>
                            <a href="https://github.com/Arjun-project" className="mr-4 hover:underline md:mr-6 hover:text-white">Arjun Kushwaha</a>
                        </li>
                        <li className='m-2' >
                            <a href="https://github.com/Aman140404" className="hover:underline hover:text-white">Aman Gupta</a>
                        </li>
                    </ul>
                </div>
